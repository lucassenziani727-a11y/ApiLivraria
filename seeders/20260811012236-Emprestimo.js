...
module.exports = {
  async up (queryInterface, Sequelize) {
      ...
      await queryInterface.bulkInsert('Emprestimos', [
        {data_emprestimo: '2026-09-10', devolucao_prevista:'2026-09-17',devolucao_real: null, status:'Em andamento', pessoaId:1,livroId:1, createdAt: new Date(), updatedAt: new Date() },
